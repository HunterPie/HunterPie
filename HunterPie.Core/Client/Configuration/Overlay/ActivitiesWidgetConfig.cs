...
[Configuration("ACTIVITIES_WIDGET_STRING", "ICON_ARGOSY", availableGames: GameProcess.MonsterHunterRise | GameProcess.MonsterHunterWorld)]
public class ActivitiesWidgetConfig : IWidgetSettings, ISettings
{
    ...
    [ConfigurationProperty("ACTIVITIES_ENABLE_TRAINING_DOJO_STRING", availableGames: GameProcess.MonsterHunterRise, group: CommonConfigurationGroups.ACTIVITIES)]
    ...
    [ConfigurationProperty("ACTIVITIES_ENABLE_COHOOT_STRING", availableGames: GameProcess.MonsterHunterRise, group: CommonConfigurationGroups.ACTIVITIES)]
    public Observable<bool> IsCohootEnabled { get; set; } = true;

    [ConfigurationProperty("ACTIVITIES_ENABLE_HARVEST_BOX_STRING", availableGames: GameProcess.MonsterHunterWorld, group: CommonConfigurationGroups.ACTIVITIES)]
    public Observable<bool> IsHarvestBoxEnabled { get; set; } = true;

    [ConfigurationProperty("ACTIVITIES_ENABLE_STEAMWORKS_STRING", availableGames: GameProcess.MonsterHunterWorld, group: CommonConfigurationGroups.ACTIVITIES)]
