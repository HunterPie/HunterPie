...
public class Strings
{
    ...
    public static string GetItemNameById(int itemId) => itemId * 2 >= _instance._itemsGmd.ValuesOffsets.Length ? null : GetRawValueString(_instance._itemsGmd, itemId * 2);
    ...
    public static string GetItemDescriptionById(int itemId) => GetRawValueString(_instance._itemsGmd, (itemId * 2) + 1).RemoveChars();
    ...
    public static string GetRawValueString(GMD gmd, int idx)
    {
        ...
        long length = (idx + 1) >= gmd.ValuesOffsets.Length
            ? gmd.ValuesChunkSize - gmd.ValuesOffsets[idx]
            : gmd.ValuesOffsets[idx + 1] - gmd.ValuesOffsets[idx];
