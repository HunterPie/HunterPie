...
public abstract class CommonPart(MonsterPartDefinition definition) : IMonsterPart, IEventDispatcher, IDisposable
{
    public MonsterPartDefinition Definition { get; } = definition;
