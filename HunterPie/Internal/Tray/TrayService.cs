...
namespace HunterPie.Internal.Tray
{
    public class TrayService
    {
        ...
        {
            _instance.notifyIcon.MouseDoubleClick += callback;
        }

        public static ToolStripMenuItem AddItem(string name)
        {
            return _instance.contextMenuStrip.Items.Add(name) as ToolStripMenuItem;
        }

        public static ToolStripMenuItem AddMenuItem(string name, ToolStripMenuItem menu)
        {
